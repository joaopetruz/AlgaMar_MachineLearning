...
tabela["corrente_velocidade_ano_anterior"] = grupo["corrente_velocidade"].shift(12)
...
tabela["corrente_media_historica_mes"] = tabela.groupby(["latitude", "longitude", "mes"])["corrente_velocidade"].transform("mean")
...
tabela["corrente_media_3anos"] = grupo["corrente_velocidade"].transform(lambda x: x.rolling(window=36, min_periods=12).mean())
...
tabela = tabela.dropna(subset=[
    ...
    "salinidade_ano_anterior", "vento_velocidade_ano_anterior", "corrente_velocidade_ano_anterior"
])
